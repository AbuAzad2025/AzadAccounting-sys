...
def upgrade():
    ...
    op.create_foreign_key('fk_employees_branch_id_branches', 'employees', 'branches', ['branch_id'], ['id'])
    op.create_foreign_key('fk_employees_site_id_sites', 'employees', 'sites', ['site_id'], ['id'])
