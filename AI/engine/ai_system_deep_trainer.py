...
class SystemDeepTrainer:
    ...
    def _train_business_workflows(self) -> int:
        workflows = {
            "عملية البيع": ["اختيار العميل", "اختيار المستودع", "إضافة المنتجات والكميات", "مراجعة الخصم والضريبة من إعدادات النظام", "حفظ/تأكيد البيع", "تحديث المخزون والقيود حسب إعدادات النظام"],
