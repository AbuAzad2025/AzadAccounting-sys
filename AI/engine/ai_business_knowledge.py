    ...
    'general_concepts': {
        ...
        'concepts': {
            'accounts_receivable': {
                ...
                'definition': 'المبالغ المستحقة للشركة من الزبائن مقابل بضائع أو خدمات تم تقديمها',
                'importance': 'تمثل سيولة مستقبلية للشركة',
                'management': [
                    'متابعة دورية لأعمار الذمم',
                    'تحصيل المستحقات في الوقت المناسب',
                    'وضع حد ائتماني لكل زبون',
...
GARAGE_MANAGEMENT_KNOWLEDGE = {
        ...
        'best_practices': {
            'appointment_scheduling': {
                ...
                'tips': [
                    ...
                    'تذكير الزبائن قبل الموعد (24 ساعة)'
                ],
                'time_allocation': {
    ...
    'pricing_strategy': {
        ...
        'methods': {
            ...
            'value_based': {
                ...
                'definition': 'تسعير حسب القيمة المدركة للزبون',
    ...
    'customer_retention': {
        ...
        'metrics': {
            'retention_rate': {
                'formula': '((الزبائن في نهاية الفترة - زبائن جدد) / زبائن في بداية الفترة) × 100',
                'target': 'أكثر من 80%'
            },
            'customer_lifetime_value': {
                'formula': 'متوسط قيمة المعاملة × عدد المعاملات سنوياً × متوسط سنوات العلاقة',
                'importance': 'يحدد كم تستثمر في اكتساب زبون جديد'
            }
        }
    }
}
...
CUSTOMER_SERVICE_KNOWLEDGE = {
    'communication': {
        ...
        'principles': {
            ...
            'clear_explanation': {
                'name': 'الشرح الواضح',
                'guidelines': [
                    'استخدم لغة بسيطة (ليس كل الزبائن ميكانيكيين)',
                    'اشرح المشكلة والحل',
    ...
    'complaint_handling': {
        ...
        'recovery_opportunities': 'زبون تم حل مشكلته بشكل ممتاز قد يصبح أكثر ولاءً من زبون لم يواجه مشكلة'
    },
...
def search_business_knowledge(query: str) -> dict:
    ...
    garage_keywords = ['كراج', 'صيانة', 'قطع غيار', 'زبائن', 'تسعير', 'garage', 'pricing']
    customer_keywords = ['خدمة زبائن', 'شكوى', 'تواصل', 'customer service', 'complaint']
