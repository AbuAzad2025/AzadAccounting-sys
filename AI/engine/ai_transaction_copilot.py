...
FIELD_HINTS = {
    ...
    "customer_id": "اختر العميل الصحيح قبل إنشاء الحركة.",
    "supplier_id": "اختر المورد الصحيح قبل إنشاء الحركة.",
    "warehouse_id": "اختر المستودع الصحيح حتى لا يتأثر مخزون خاطئ.",
}

CODE_ACTIONS = {
    "PAYMENT_BAD_DIRECTION": ["اختر IN إذا كان قبض من عميل.", "اختر OUT إذا كان صرف لمورد أو مصروف.", "راجع كشف الجهة بعد الحفظ."],
...
def next_best_action(model_name: str, issue_code: str = "") -> str:
    ...
    if "sale" in model or "invoice" in model:
        return "راجع العميل، البنود، الكميات، الأسعار، الخصم، والإجمالي."
